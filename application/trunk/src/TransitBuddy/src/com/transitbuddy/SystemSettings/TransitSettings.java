...
public class TransitSettings {
    ...
    // Default values
    private static final int DEFAULT_ETA_INDEX          = 4;
    private static final int DEFAULT_VICINITY_INDEX     = 4;
    ...
    public static final String DEFAULT_USERNAME = "NO SUCH USER";
    public static final String DEFAULT_PASSWORD = "NO SUCH PASSWORD";
    public static final String DEFAULT_CITY = "NO CITY";
	 ...
	 * 
	 */
	public void setSelectedCity(String systemID) {
	    SharedPreferences.Editor prefs = tbApp.getSharedPreferences(PREFS, 
                Context.MODE_PRIVATE).edit();
	    Log.v("IN TRANSITSETTINGS, SETTING SELECTED CITY TO: ", systemID);
        prefs.putString(SELECTED_CITY, systemID);
        prefs.commit();
	}
	
	/**
	 * 
	 * @return The transit system ID
	 */
