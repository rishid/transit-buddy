...
public class TransitTrip extends TransitName
{
	 ...
	 * @param stops
	 */
	public TransitTrip(String name, String id, ArrayList<TransitStop> stops)
	{
		super(name, id);
	 ...
	 * @param name
	 */
	public TransitTrip(String name, String id)
	{
		this(name, id, null);
	}
	...
	public void setStops(ArrayList<TransitStop> stops)
	{
		mStops = stops;
	}
}
